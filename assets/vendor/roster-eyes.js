...
export const EYE_STYLES = Object.freeze({
  ...
  'evolved-dragon': { label:'Toxic green balefire slits', refs:[10,23], iris:0x39ff14, white:0x152510, size:.76, pupil:[.115,.58], shape:[1.05,.79], lid:.40, slant:.24, glow:.45, lidColor:0x222a25 },
  'skull-orc': { label:'Furnace embers in dark sockets', refs:[4,12], iris:0xff6600, white:0x140800, size:.42, pupil:[.12,.18], shape:[1,.95], lid:.94, glow:.45, shine:.4, lidColor:0x22262c },
  ...
  'fish-monster': { label:'Luminous cyan ocean eyes', refs:[7,15], iris:0x00f0ff, white:0x061824, size:.77, pupil:[.40,.45], shape:[1.05,1.02], lid:.88, glow:.35, lidColor:0x123644 },
  demon: { label:'Flaming fire imp eyes', refs:[8,17], iris:0xffb700, white:0x2a1005, size:.58, pupil:[.15,.40], shape:[1.02,1.05], lid:.85, glow:.50, lidColor:0x1a161c },
  tribal: { label:'Glowing crimson mask slits', refs:[5,21], iris:0xff1e1e, white:0x1f0606, size:.76, pupil:[.22,.55], shape:[1.08,.85], lid:.65, glow:.45, lidColor:0xf5f3eb },
  ...
  ninja: { label:'Narrow oni crimson focus', refs:[9,16], iris:0xff2244, white:0x1c050a, size:.62, pupil:[.18,.42], shape:[1.12,.62], lid:.38, slant:.22, glow:.40, lidColor:0x14161a },
  ...
  squidle: { label:'Glowing amber cosmic nodes', refs:[17,25], iris:0xffaa00, white:0x1c0c30, size:.68, pupil:[.35,.45], shape:[.92,1.15], lid:[.87,.54], glow:.38, lidColor:0x241040 },
});
